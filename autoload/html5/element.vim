...
call html5core#class('HTMLMediaElement', 'HTMLElement', [ 
  ...
  \ html5core#prop('NETWORK_EMPTY', 'unsigned short'),
  \ html5core#prop('NETWORK_IDLE', 'unsigned short'),
  \ html5core#prop('NETWORK_LOADING', 'unsigned short'),
  \ html5core#prop('NETWORK_NO_SOURCE', 'unsigned short'),
  \ html5core#prop('networkState', 'short'),
  \ html5core#prop('preload', 'preloadString'),
  \ html5core#prop('buffered', 'TimeRanges'),
  \ html5core#method('load(', ')', 'void'),
  \ html5core#method('canPlayType(', 'in String type)', 'String'),
  \ html5core#prop('HAVE_NOTHING', 'unsigned short'),
  \ html5core#prop('HAVE_METADATA', 'unsigned short'),
  \ html5core#prop('HAVE_CURRENT_DATA', 'unsigned short'),
  \ html5core#prop('HAVE_FUTURE_DATA', 'unsigned short'),
  \ html5core#prop('HAVE_ENOUGH_DATA', 'unsigned short'),
