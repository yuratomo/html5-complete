...
call html5core#class('_global', '', [ 
  ...
  \ html5core#prop('onabort', 'abort'),
  \ html5core#prop('onblur', 'blur'),
  \ html5core#prop('oncanplay', 'canplay'),
  \ html5core#prop('oncanplaythrough', 'canplaythrough'),
  \ html5core#prop('onchange', 'change'),
  \ html5core#prop('onclick', 'click'),
  \ html5core#prop('oncontextmenu', 'contextmenu'),
  \ html5core#prop('oncuechange', 'cuechange'),
  \ html5core#prop('ondblclick', 'dblclick'),
  \ html5core#prop('ondrag', 'drag'),
  \ html5core#prop('ondragend', 'dragend'),
  \ html5core#prop('ondragenter', 'dragenter'),
  \ html5core#prop('ondragleave', 'dragleave'),
  \ html5core#prop('ondragover', 'dragover'),
  \ html5core#prop('ondragstart', 'dragstart'),
  \ html5core#prop('ondrop', 'drop'),
  \ html5core#prop('ondurationchange', 'durationchange'),
  \ html5core#prop('onemptied', 'emptied'),
  \ html5core#prop('onended', 'ended'),
  \ html5core#prop('onerror', 'error'),
  \ html5core#prop('onfocus', 'focus'),
  \ html5core#prop('onformchange', 'formchange'),
  \ html5core#prop('onforminput', 'forminput'),
  \ html5core#prop('oninput', 'input'),
  \ html5core#prop('oninvalid', 'invalid'),
  \ html5core#prop('onkeydown', 'keydown'),
  \ html5core#prop('onkeypress', 'keypress'),
  \ html5core#prop('onkeyup', 'keyup'),
  \ html5core#prop('onload', 'load'),
  \ html5core#prop('onloadeddata', 'loadeddata'),
  \ html5core#prop('onloadedmetadata', 'loadedmetadata'),
  \ html5core#prop('onloadstart', 'loadstart'),
  \ html5core#prop('onmousedown', 'mousedown'),
  \ html5core#prop('onmousemove', 'mousemove'),
  \ html5core#prop('onmouseout', 'mouseout'),
  \ html5core#prop('onmouseover', 'mouseover'),
  \ html5core#prop('onmouseup', 'mouseup'),
  \ html5core#prop('onmousewheel', 'mousewheel'),
  \ html5core#prop('onpause', 'pause'),
  \ html5core#prop('onplay', 'play'),
  \ html5core#prop('onplaying', 'playing'),
  \ html5core#prop('onprogress', 'progress'),
  \ html5core#prop('onratechange', 'ratechange'),
  \ html5core#prop('onreadystatechange', 'readystatechange'),
  \ html5core#prop('onreset', 'reset'),
  \ html5core#prop('onscroll', 'scroll'),
  \ html5core#prop('onseeked', 'seeked'),
  \ html5core#prop('onseeking', 'seeking'),
  \ html5core#prop('onselect', 'select'),
  \ html5core#prop('onshow', 'show'),
  \ html5core#prop('onstalled', 'stalled'),
  \ html5core#prop('onsubmit', 'submit'),
  \ html5core#prop('onsuspend', 'suspend'),
  \ html5core#prop('ontimeupdate', 'timeupdate'),
  \ html5core#prop('onvolumechange', 'volumechange'),
  \ html5core#prop('onwaiting', 'waiting'),
  \ ])
